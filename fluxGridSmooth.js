...
function setRandomBackgroundColor(){
  ...
  if (document.body.style.backgroundColor == ""){
    ...
    initBGcolor = [
      (sarr[0] + random(-colorChange, colorChange) % 255),
      (sarr[1] + random(-colorChange, colorChange) % 255),
      (sarr[2] + random(-colorChange, colorChange) % 255),
      255
    ];
  }
...
function grid(){
  ...
  cArr = get(xindex, yindex);
  for (let x = xindex; x > 0; x--){
